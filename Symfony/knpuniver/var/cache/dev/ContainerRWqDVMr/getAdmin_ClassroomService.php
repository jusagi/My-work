...
$this->factories['admin.classroom'] = function () {
    // Returns the public 'admin.classroom' autowired service.

    $instance = new \App\Admin\ClassroomAdmin('admin.classroom', 'App\\Entity\\Classroom', 'SonataAdminBundle:CRUD');
    ...
    $instance->setLabel('Classroom');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.classroom.template_registry'] ?? $this->load('getAdmin_Classroom_TemplateRegistryService.php')));
...
return $this->factories['admin.classroom']();
