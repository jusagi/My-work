...
$this->factories['admin.student'] = function () {
    // Returns the public 'admin.student' autowired service.

    $instance = new \App\Admin\StudentAdmin('admin.student', 'App\\Entity\\Student', 'SonataAdminBundle:CRUD');
    ...
    $instance->setTemplateRegistry(($this->services['admin.student.template_registry'] ?? $this->load('getAdmin_Student_TemplateRegistryService.php')));
...
return $this->factories['admin.student']();
