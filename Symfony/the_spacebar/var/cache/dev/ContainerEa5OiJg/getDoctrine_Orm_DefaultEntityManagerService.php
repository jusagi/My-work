...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\BlogPostRepository' => function () {
...
}, 'App\\Repository\\ClassroomRepository' => function () {
    return ($this->privates['App\Repository\ClassroomRepository'] ?? $this->load('getClassroomRepositoryService.php'));
}, 'App\\Repository\\StudentRepository' => function () {
    return ($this->privates['App\Repository\StudentRepository'] ?? $this->load('getStudentRepositoryService.php'));
}))));
